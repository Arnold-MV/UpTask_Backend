...
exports.TaskSchema = new mongoose_1.Schema({
    ...
    project: { type: mongoose_1.Types.ObjectId, ref: "Project" }, //con ref relacionamos tareas con  proyectos
    status: {
        type: String,
    ...
    notes: [{ type: mongoose_1.Types.ObjectId, ref: "Note" }], //con ref relacionamos tareas con notas
}, { timestamps: true });
// Middleware
